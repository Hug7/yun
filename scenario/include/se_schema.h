...
class DistMatrixSchema {
 public:
  ...
  static constexpr std::array headers{
      "FromLocationCode", "ToLocationCode", "DistMatrixCode", "Distance", "Time",
  };
};
...
class VehicleSchema {
 public:
  ...
  static constexpr std::array headers{
      "CarrierCode", "VehicleModelCode", "Count", "OriginLocationCode", "DestinationLocationCode",
  };
};
...
class WorkCalendarWeeklySchema {
 public:
  ...
  static constexpr std::array headers{
      "LocationCode", "CalendarType", "Monday",   "Tuesday", "Wednesday",
