...
public:
    ...
    DistMatrixManager(const int matrix_len) : matrix_len(matrix_len),
     ...
     */
    void create_dist_matrix_code(const std::string &dist_matrix_code, const std::string &dist_matrix_code_name);
    /**
     * @brief 获取距离矩阵编码
     * @param dist_matrix_code 距离矩阵自定义code
     */
     ...
     */
    void set_dist_time(const std::string &dist_matrix_code, const int row_ind, const int col_ind, const long cost_dist, const long cost_time);
    /**
     * @brief 获取距离矩阵
     * @param dist_matrix_code 距离矩阵自定义code
