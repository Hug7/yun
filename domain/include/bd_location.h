...
public:
    ...
    Location(const std::string &code, const std::string &name, const int ind,
...
public:
     ...
     */
    Location *create_location(const std::string &code, const std::string &name, const double lat, const double lng);
