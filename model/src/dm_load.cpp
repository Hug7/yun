...
void Load::change_vehicle(Vehicle *vehicle)
{
    ...
    if (this->vehicle != nullptr || this->prev_dist_matrix_code != this->vehicle->get_dist_matrix_code())
    {
...
{
    const DistMatrix *dist_matrix = this->vehicle->get_dist_matrix();
    auto dist_time = dist_matrix->get_dist_time(this->first_node->loc->ind, this->first_node->next->loc->ind);
...
{
    const DistMatrix *dist_matrix = this->vehicle->get_dist_matrix();
    auto dist_time = dist_matrix->get_dist_time(this->last_node->prev->loc->ind, this->last_node->loc->ind);
