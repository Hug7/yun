...
Activity::Activity(const ActivityType activity_type,
                   const Order *order) : activity_type(activity_type), order(order)
{
    this->prev = nullptr;
    this->next = nullptr;
    this->related = nullptr;
...
void Activity::set_prev(Activity *prev)
{
    this->prev = prev;
}
...
void Activity::set_related(Activity *related)
{
    this->related = related;
}

void Activity::set_related_node(Node *related_node)
{
    this->related_node = related_node;
}

bool Activity::hase_next()
{
    return this->next != nullptr;
}

bool Activity::hase_prev()
{
